...
<link rel="stylesheet" href="<?php echo $board_skin_url ?>/style.css?1">
...
<section id="bo_w">
    ...
    <h1><?=$board['bo_subject']?></h1>
        ...
        <tr>
            <th scope="row"><label for="wr_1">신문사</label></th>
            <td>
                <div>
                    <input type="text" name="wr_1" value="<?php echo $wr_1?>" id="wr_1" class="frm_input required" size="10" maxlength="255">
                </div>
            </td>
            <th scope="row"><label for="wr_2">기사일자</label></th>
            <td>
                <div>
                    <input type="text" name="wr_2" value="<?php echo $wr_2?>" id="wr_2" class="frm_input required" size="10" maxlength="255">
                </div>
            </td>
        </tr>
	</thead>
