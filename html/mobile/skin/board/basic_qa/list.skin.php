...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <tr>
        ...
        <th scope="col"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>현황</a></th>
    ...
    <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?><?php if ($board[1]) echo "bo_sideview"; ?>">
        ...
        <td class="td_num"><?php if ($list[$i]['comment_cnt']) { ?><img src="<?php echo $board_skin_url ?>/img/qa_icon2.gif" alt="첨부"><?php } else { ?><img src="<?php echo $board_skin_url ?>/img/qa_icon1.gif" alt="첨부"> <?php } ?></td>
