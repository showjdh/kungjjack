...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr> 
            <th scope="row"><label for="reg_mb_KAKAO_ID">카카오톡 ID<strong class="sound_only">필수</strong></label></th> 
            <td><input type="text" name="KAKAO_ID" id="reg_mb_KAKAO_ID" <?php echo $required ?> class="frm_input <?php echo $required ?>" minlength="3" maxlength="20"></td> 
        </tr>
        </table>
    </div>
    ...
    function authen(){
    	var id = $('#reg_mb_SKKU_ID').val();
    	var pwd = $('#reg_mb_SKKU_PWD').val();
    	// $.ajax({
    	// 	url: 'http://sugang.skku.edu/skku/login?attribute=loginChk&lang=KO&id='+id+'&pwd='+pwd,
    	// 	type: 'GET',
    	...
    	// 	}
    	// });
    	// $.getJSON('http://sugang.skku.edu/skku/login?attribute=loginChk&lang=KO&id='+id+'&pwd='+pwd, function(data) {
    	// 	if (data.code == "200")
    	// 			alert('성균관대학교 학생입니다...');
    	// 		else
    	// 			alert('성균관대학교 학생이 아닙니다...,...');
    ...
    function fregisterform_submit(f)
    {
     ...
     //    <?php
     //    $url = 'http://sugang.skku.edu/skku/login?attribute=loginChk&lang=KO&id=SKKU_ID&pwd=SKKU_PWD';
        
     //    $json = file_get_contents($url);
	    // $data = json_decode($json, TRUE);

     //    //echo alert(parse_url);
	    // if($data[0] == 200){
	    // 	alert('성균관대학교 학생입니다.');
	    // 	return true;
	    // }else{
