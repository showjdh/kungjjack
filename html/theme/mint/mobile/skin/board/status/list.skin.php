...
<?php if($member['mb_level'] > 7) {?>             <th scope="col"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회</a></th><? } ?>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo G5_HTTP_BBS_URL ?>/write.php?w=u&bo_table=eStatus&wr_id=<?php echo $list[$i]['wr_id'] ?>&page=">  
            ...
            <td class="td_num"><?php echo $list[$i]['wr_5'] ?>명  </td>
            <td class="td_num"><?php echo number_format($list[$i]['wr_4']) ?>원</td>
            <td class="td_date"><?php echo $list[$i]['datetime2'] ?></td>
            <td class="td_name"><?php echo $list[$i]['wr_name'] ?></td>
            <td class="td_num"> <a href="<?php echo G5_HTTP_BBS_URL ?>/write.php?w=u&bo_table=eStatus&wr_id=<?php echo $list[$i]['wr_id'] ?>&page="> <?php echo $list[$i]['wr_10'] ?></a></td>
