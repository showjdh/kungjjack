    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>width:<?php echo $board['bo_gallery_width'] ?>px">
            ...
            <ul class="gall_con">
                ...
                <li><span class="gall_subject">주최: </span><?php echo $list[$i]['wr_1'] ?></li>
                <li><span class="gall_subject">행사: </span><?php echo $list[$i]['wr_2']  ?> ~ <?php echo $list[$i]['wr_3'] ?></li>
                <li><span class="gall_subject">참가비: </span><?php echo $list[$i]['wr_4'] ?>원</li>
