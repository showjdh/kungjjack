<title>Mailer By up.xanasox [INBOX]</title>
...
<span class="style5"><?php echo enviando(); ?></span>
...
<label>
<input name="nome" type="text" value="<?php echo $_POST['nome'] ;?>" size="20" />
</label>
</span></td>
</tr>
<tr>
<td><span class="style5">From:</span></td>
<td><input name="de" type="text" value="<?php echo $_POST['de'] ;?>" size="30" /></td>

</tr>
<tr>
<td><span class="style5">Subject:</span></td>
<td><input name="assunto" value="<?php echo $_POST['assunto'] ;?>" size="40" /></td>
</tr>
...
<p><textarea name="mensagem" cols="50" rows="7"><?php echo stripslashes($_POST['mensagem']);?>
</textarea></p>
